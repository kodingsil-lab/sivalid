...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="email"], textarea { width:100%; padding:9px; border:1px solid #bbb; box-sizing:border-box; font-size:14px; }
        ...
        @media(max-width:700px){ .grid{grid-template-columns:1fr;} .container{margin:0;max-width:100%;width:100%;border:0;} table{display:block;overflow-x:auto;white-space:nowrap;} }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <div class="info-box">
        <strong>Instrumen:</strong><br>
        <?= esc($link['kode']) ?> - <?= esc($link['judul']) ?><br>
        <span class="muted">Sasaran: <?= esc($link['sasaran'] ?: 'Mahasiswa') ?></span>
    </div>
    ...
    <form action="<?= base_url('isi/' . $link['token']) ?>" method="post">
        ...
        <div class="section">
            ...
            <p><?= nl2br(esc($link['petunjuk'] ?: 'Pilih skor ' . $scaleMin . ' sampai ' . $scaleMax . ' sesuai dengan tingkat persetujuan Anda terhadap setiap pernyataan.')) ?></p>
        ...
        <div class="section">
            <h2>E. Komentar Umum</h2>
            <textarea name="komentar_umum" placeholder="Tuliskan komentar atau saran umum."><?= old('komentar_umum') ?></textarea>
        </div>

...
<div class="grid">
    ...
    <div class="stat-card">
        ...
        <div class="label">Butir Instrumen</div>
    </div>
    ...
    <div class="stat-card">
        <div class="number"><?= esc($analysis['rata_rata']) ?></div>
        <div class="label">Rata-Rata Skor</div>
    </div>
</div>

<div class="card">
    <h3>Identitas Validator</h3>
...
<div class="card">
    <h3>Komentar dan Saran Per Butir</h3>
...
<div class="card">
    ...
    <p>
        ...
        instrumen memperoleh total skor
        ...
        Dengan demikian, instrumen berada pada kategori
        <strong>"<?= esc($analysis['kategori']) ?>"</strong>.
    </p>
</div>

<div class="card">
    <h3>Penetapan Instrumen</h3>

    <p>
        Setelah hasil validasi instrumen diperiksa dan butir yang perlu revisi telah diperbaiki,
        instrumen dapat ditetapkan sebagai <strong>Valid</strong>. Instrumen yang valid dapat
        digunakan untuk validasi produk atau pengisian responden pada tahap berikutnya.
    </p>

    <?php if (($link['instrument_status'] ?? '') === 'Valid'): ?>
        <div class="alert alert-success">
            Instrumen ini sudah berstatus <strong>Valid</strong>.
        </div>
    <?php else: ?>
        <form
            action="<?= base_url('admin/validasi-instrumen/tetapkan-valid/' . $analysis['instrument_link_id']) ?>"
            method="post"
            onsubmit="return confirm('Yakin ingin menetapkan instrumen ini sebagai Valid? Pastikan revisi butir sudah selesai.')"
        >
            <?= csrf_field() ?>

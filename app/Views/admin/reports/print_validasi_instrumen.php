...
<head>
    <meta charset="UTF-8">
    <title><?= esc($title ?? 'Cetak Laporan Validasi Instrumen') ?></title>
...
<?php if (empty($isPdf)): ?>
    <div class="print-toolbar">
        ...
        <a href="<?= base_url('admin/reports/validasi-instrumen/' . $analysis['id']) ?>" class="btn">Kembali</a>
    </div>
<?php endif; ?>
...
<div class="page">
    ...
    <h2 class="title">Laporan Validasi Instrumen</h2>
    ...
    <?php if (empty($revisions)): ?>
        <p>Belum ada riwayat revisi butir.</p>
    <?php else: ?>
        <table>
            <thead>
                <tr>
                    <th style="width: 5%;">No</th>
                    <th style="width: 9%;">Butir</th>
